...
finitemeanflag = True
#####################
Nslabsexpected=int(initiallength*2/5)
runsteps=8000/ts		## Expected but may be shorter or longer - keep non restrictive
heatsteps=500/ts
...
Edataori = np.loadtxt(Efname, delimiter=' ', comments='#', skiprows=0, max_rows=None)/2
...
deltax = xlength - initiallength*bathsize/xlength
